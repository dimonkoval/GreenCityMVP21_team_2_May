...
import greencity.validator.ValidSameDayValidator;
...
@Constraint(validatedBy = ValidSameDayValidator.class)
public @interface ValidSameDay {
    /**
     * Defines the message that will be showed when the input data is not valid.
     *
     * @return message
     */
    String message() default "StartDate and EndDate must be on the same day";
